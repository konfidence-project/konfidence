// Package cli provides operational wiring for resolving OCM crypto
// dependencies (verifiers, signers) from environment variables and registering
// the necessary watches with a controller-runtime manager.
package cli
