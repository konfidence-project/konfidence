[![REUSE status](https://api.reuse.software/badge/github.com/konfidence-project/konfidence/internal/galaxy-sync)](https://api.reuse.software/info/github.com/konfidence-project/konfidence/internal/galaxy-sync)
...
This project is open to feature requests, suggestions, and bug reports via [GitHub issues](https://github.com/konfidence-project/konfidence/internal/galaxy-sync/issues). Contributions are encouraged and always welcome. For more information on how to contribute, see our [Contribution Guidelines](CONTRIBUTING.md).

## Security / Disclosure

If you find a bug that may be a security problem, please follow the instructions in our [security policy](https://github.com/konfidence-project/konfidence/internal/galaxy-sync/security/policy) on how to report it. Please do not create GitHub issues for security-related concerns.
