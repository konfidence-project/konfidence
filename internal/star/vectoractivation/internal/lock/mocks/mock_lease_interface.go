...
// Source: k8s.io/client-go/kubernetes/typed/coordination/v1 (interfaces: LeaseInterface)
//
// Generated by this command:
//
//	mockgen -destination=internal/lock/mocks/mock_lease_interface.go -package=mocks k8s.io/client-go/kubernetes/typed/coordination/v1 LeaseInterface
//
