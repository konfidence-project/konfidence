...
The Task Orchestration Controller retrieves the task definition, extracts the required information, and creates TaskExecution custom resources. Its purpose is to identify all tasks in the VectorMigration and orchestrate their execution.
