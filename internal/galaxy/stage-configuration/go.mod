...
require (
	...
	github.com/konfidence-project/crds/api/global v0.8.1
...
require (
	...
	ocm.software/open-component-model/bindings/go/transfer v0.0.0-20260331115705-3c08b3ee535c // indirect
