...
// landscapeNamespaceChanged admits landscape events that can change stage
// resolution. A landscape's managed namespace is effectively immutable once
// set, so the update branch is defensive; create and delete are the real
// signals.
