...
manifests-star: hermit ## Generate CRDs and RBAC manifests for the star operator.
	...
	@mkdir -p api/star/config/bases/crd api/star/config/release
	$(CONTROLLER_GEN) rbac:roleName=star-manager crd webhook \
		paths="./internal/star/..." paths="./api/star/..." \
		output:crd:artifacts:config=api/star/config/bases/crd
	@echo "  Generating kustomization.yaml..."
	@{ \
		echo "# Code generated by make manifests. DO NOT EDIT."; \
		echo "resources:"; \
		find api/star/config/bases/crd -type f -name '*.yaml' | sort | sed -E 's|^api/star/config/bases/| - |'; \
	} > api/star/config/bases/kustomization.yaml
	@echo "  Building release bundle..."
	@$(KUSTOMIZE) build api/star/config/bases > api/star/config/release/install.yaml
...
manifests-galaxy: hermit ## Generate CRDs and RBAC manifests for the galaxy operator.
	...
	@mkdir -p api/galaxy/config/bases/crd api/galaxy/config/release
	$(CONTROLLER_GEN) rbac:roleName=galaxy-manager crd webhook \
		paths="./internal/galaxy/..." paths="./api/galaxy/..." \
		output:crd:artifacts:config=api/galaxy/config/bases/crd
	@echo "  Generating kustomization.yaml..."
	@{ \
		echo "# Code generated by make manifests. DO NOT EDIT."; \
		echo "resources:"; \
		find api/galaxy/config/bases/crd -type f -name '*.yaml' | sort | sed -E 's|^api/galaxy/config/bases/| - |'; \
	} > api/galaxy/config/bases/kustomization.yaml
	@echo "  Building release bundle..."
	@$(KUSTOMIZE) build api/galaxy/config/bases > api/galaxy/config/release/install.yaml
