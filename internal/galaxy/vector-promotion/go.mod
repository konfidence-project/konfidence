module github.com/konfidence-project/gcp-vector-promotion-controller
...
require (
	...
	github.com/konfidence-project/crds/api/global v0.9.0
	github.com/konfidence-project/pkg v0.16.0
