...
func NewLegacy(baseURL string, timeout time.Duration) *LegacyClient {
	return &LegacyClient{
		base: baseURL,
...
func (c *LegacyClient) Healthz(ctx context.Context) (*StatusResponse, error) {
	return c.getJSON(ctx, "/healthz")
}

// Readyz calls GET /readyz and returns the response body.
func (c *LegacyClient) Readyz(ctx context.Context) (*StatusResponse, error) {
	return c.getJSON(ctx, "/readyz")
}

func (c *LegacyClient) getJSON(ctx context.Context, path string) (*StatusResponse, error) {
