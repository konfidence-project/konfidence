...
//	    req.Namespace,
//	    credentialsConfig, // []konfidence.CredentialsConfig from the reconciled resource
//	)
//	if err != nil {
...
//	    func(ctx context.Context, k8sClient client.Reader, namespace string, creds []konfidence.CredentialsConfig) (repository.Client, error) {
