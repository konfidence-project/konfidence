...
.PHONY: run-star
run-star: manifests-star generate fmt-go vet ## Run the star operator from your host.
	go run ./cmd/star/main.go

.PHONY: run-galaxy
run-galaxy: manifests-galaxy generate fmt-go vet ## Run the galaxy operator from your host.
