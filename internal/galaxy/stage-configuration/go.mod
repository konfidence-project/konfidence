...
require (
	...
	github.com/konfidence-project/crds/api/common v0.6.1
	github.com/konfidence-project/crds/api/global v0.2.1
...
require (
	...
	ocm.software/open-component-model/bindings/go/descriptor/runtime v0.0.0-20260121102622-0ca4a0eda789 // indirect
