...
func NewCacheFactory(log logr.Logger, limiter crypto.Limiter) clientcache.Factory[*galaxy.StageConfiguration, ports.VectorPort] {
	return func(ctx context.Context, k8sClient client.Reader, cr *galaxy.StageConfiguration) (ports.VectorPort, error) {
