...
export RSA_SIGNING_KEY_SECRET_NAME="${SIGNING_SECRET_NAME}"
export RSA_SIGNING_KEY_SECRET_NAMESPACE="${SIGNING_NS}"
...
export RSA_SIGNING_KEY_SECRET_NAME="${RSA_SIGNING_KEY_SECRET_NAME}"
export RSA_SIGNING_KEY_SECRET_NAMESPACE="${RSA_SIGNING_KEY_SECRET_NAMESPACE}"
